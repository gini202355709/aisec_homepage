...
export default function AssociationPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7fbff] text-[#111827] overflow-hidden">
      {/* 히어로 섹션 */}
      <section className="relative min-h-[640px] bg-gradient-to-br from-white via-[#eef8ff] to-[#dbeeff] overflow-hidden">
        ...
        <div className="relative max-w-[1320px] mx-auto px-6 md:px-10 pt-28 pb-24">
          <div className="max-w-[820px]">
            ...
            <h1 className="text-[42px] md:text-[68px] font-black leading-[1.08] tracking-[-0.045em] break-keep text-slate-950">
              안전하고 신뢰할 수 있는
              <br />
              <span className="text-transparent bg-clip-text bg-[#2563eb] via-[#0284c7] to-[#06b6d4]">
                AI 보안 생태계
              </span>
              를 만듭니다
            </h1>
          ...
          <div className="grid md:grid-cols-4 gap-5 mt-20">
            {[
              [BrainCircuit, 'AI Security', '인공지능 보안 연구'],
              [LockKeyhole, 'Trust Standard', '신뢰성·표준화 체계'],
              [Network, 'Cooperation', '산학연관 협력 네트워크'],
              [Globe2, 'Global Vision', '글로벌 보안 생태계'],
      ...
      <section className="relative py-24">
        ...
        <div className="relative max-w-[1320px] mx-auto px-6 md:px-10 grid lg:grid-cols-[300px_1fr] gap-10">
          <aside className="hidden lg:block">
            <div className="sticky top-28 rounded-[32px] overflow-hidden bg-white border border-blue-100 shadow-[0_24px_70px_rgba(37,99,235,0.08)]">
...
function SectionTitle({
  ...
  return (
    <div className="mb-9">
      <div className="w-15 h-15 rounded-[22px] flex items-center justify-center mb-5 bg-[#eff6ff] text-[#2563eb] border border-blue-100">
        {icon}
      </div>
